package me.maximilian1021.filemanger;
...
public class FileManager {
    public static void createLanguageFile() {
        ...
        if (!file.exists()) {
            ...
            lang.set("German.NoPerm", "§c Du hast nicht genügend Permission");
            ...
            lang.set("German.CHGSpectate", "§a Dein Gamemode wurde auf §bSpectate §agesetzt!");
